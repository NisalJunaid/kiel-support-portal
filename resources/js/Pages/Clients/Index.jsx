  ...
  return (
    <AppLayout title="Client Companies" description="Manage customer accounts and ownership." breadcrumbs={[{ label: 'Home', href: '/dashboard' }, { label: 'Clients' }]}>
      <SectionCard
        ...
        description="Track customer records, status, and account ownership."
        action={can.create && <Button asChild size="sm"><Link href="/clients/create">Create client</Link></Button>}
      >
        <FilterBar
