    ...
    <form onSubmit={onSubmit} className="space-y-4">
      <Card>
        ...
        <CardContent className="grid gap-4 md:grid-cols-2">
          ...
          <div className="space-y-2"><Label>SLA plan ID</Label><Input type="number" value={data.sla_plan_id || ''} onChange={(e) => setData('sla_plan_id', e.target.value)} /><p className="text-xs text-destructive">{errors.sla_plan_id}</p></div>
